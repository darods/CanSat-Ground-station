...
text = pg.TextItem(html='<div style="text-align: center"><span style="color: #FFF;">This is the</span><br><span style="color: #FF0; font-size: 36pt;">PEAK</span></div>',
...
# probando caja que se actualiza
text3 = pg.TextItem("test3", anchor=(1, 1))
plot.addItem(text3)
# text3.setText("hola que hace")
text3.setPos(0, 0)
text3.setFont(font)
